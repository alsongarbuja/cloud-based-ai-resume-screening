...
export default function PricingPage() {
  ...
  const handleCheckout = (tierName: string, price: number) => {
    ...
    if (tierName === "Enterprise") {
      ...
      alert("Please contact sales@kaamai.com for enterprise pricing");
      return;
    }
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid md:grid-cols-3 gap-8">
          {pricingTiers.map((tier) => (
            <div
              key={tier.name}
              className={`relative rounded-2xl border-2 ${tier.color} p-8 bg-card/50 backdrop-blur-sm ${
                tier.popular
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="text-center space-y-4">
            ...
            <p className="text-sm text-muted-foreground/80">
              © 2025 KaamAI. All rights reserved.
            </p>
          </div>
        </div>
      </div>
